...
v4.1.0: Added immersive soundscapes for all 10 regions & premium themes, crossfading audio, an interactive jukebox region selector, Google login deep-link redirection on Android/iOS, startup data sync protection, and theme visual asset fixes.
